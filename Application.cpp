...
void Application::processCommands()
{
	...
	while (mCommand = commandHolder.pop())
	{
		...
		case Command::RunMaxPathAlg:
			...
			break;
		case Command::Hamilton:
			workBench->setState(WorkBenchState::Hamilton);
			break;
...
{	
	...
	std::shared_ptr<Button> hamilton_button(new Button);
	std::shared_ptr<Button> min_path_button(new Button);
	std::shared_ptr<Button> max_path_button(new Button);
	std::shared_ptr<Button> max_flow_button(new Button);
	...
	hamilton_button->setColors(sf::Color(60, 60, 60), sf::Color(90, 90, 90), sf::Color(45, 45, 45));
	...
	max_flow_button->setColors(sf::Color(60, 60, 60), sf::Color(90, 90, 90), sf::Color(45, 45, 45));
	...
	hamilton_button->setSize(sf::Vector2f(200, 50));
	min_path_button->setSize(sf::Vector2f(200, 50));
	max_path_button->setSize(sf::Vector2f(200, 50));
	max_flow_button->setSize(sf::Vector2f(200, 50));
	...
	hamilton_button->setPosition(sf::Vector2f(100, 50));
	min_path_button->setPosition(sf::Vector2f(100, 100));
	max_path_button->setPosition(sf::Vector2f(100, 150));
	max_flow_button->setPosition(sf::Vector2f(100, 200));
	...
	hamilton_button->setCommand(&commandHolder, Command::Hamilton);
	...
	max_flow_button->setCommand(&commandHolder, Command::RunMaxFlowAlg);
	...
	if (fonts.contains(Fonts::Main))
	{
		...
		hamilton_button->setText(fonts.get(Fonts::Main), 20, sf::Color::White, sf::Text::Bold, "HAMILTON");
		...
		max_flow_button->setText(fonts.get(Fonts::Main), 20, sf::Color::White, sf::Text::Bold, "MAX FLOW");
	}
	...
	menuBar->setFixedPosition(window, FixedPosition::Left, FixedPosition::Top, sf::Vector2f(0, 0));
		...
		algorithmButtonBox->setSize(sf::Vector2f(200, 250));
		algorithmButtonBox->addButton(hamilton_button);
		algorithmButtonBox->addButton(min_path_button);
		algorithmButtonBox->addButton(max_path_button);
		algorithmButtonBox->addButton(max_flow_button);
